...
if __name__ == "__main__":
    ...
    """
    rospy.Subscriber("/camera/color/image_raw/", Image, video_streamer.colour_callback)
    rospy.Subscriber("/camera/aligned_depth_to_color/image_raw", Image, video_streamer.depth_callback)
    rospy.Subscriber("/camera/aligned_depth_to_color/camera_info", CameraInfo, video_streamer.intrin_callback)
